...
namespace StaffManagement.Data
{
    public partial class accountmanagementContext : DbContext
    {
        ...
        public virtual DbSet<Export_Contractor> Contractors { get; set; }
        ...
        public virtual DbSet<GroupCount> GroupCounts { get; set; }
        ...
        public virtual DbSet<JobTitleAssignment> JobTitleAssignment { get; set; }
        ...
        public virtual DbSet<MostRecentDatum> MostRecentData { get; set; }
        public virtual DbSet<Office365Employee> Office365Employees { get; set; }
        ...
        public virtual DbSet<StaffTermination> StaffTerminations { get; set; }
        ...
        //public DbQuery<AccountDetail> AccountDetail { get; set; }
       ...
       // {
        ...
        //        //  optionsBuilder.UseSqlServer("Server=BSD155261\\SQLEXPRESS;Database=accountmanagement;Integrated Security=true;TrustServerCertificate=False;MultipleActiveResultSets=true");
        //       // optionsBuilder.Options = _options;
        //      //  optionsBuilder.UseLoggerFactory(_loggerFactory);
       ...
       //}
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Export_Contractor>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Contractor", "export");
                ...
                entity.Property(e => e.SchoologyUserId).HasMaxLength(256);
            ...
            modelBuilder.Entity<EmployeeJob>(entity =>
            {
                ...
                .HasPrincipalKey<Jobcode>(p => p.JobcodeId)
                .HasForeignKey<EmployeeJob>(p => p.Jobcode);

                entity.HasOne(d => d.PersonnelCodes)
              .WithOne(p => p.EmployeeJob)
              .HasPrincipalKey<PersonnelCode>(p => p.Personnel_Code)
              .HasForeignKey<EmployeeJob>(p => p.PersonnelCode);
            ...
            modelBuilder.Entity<GroupCount>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("GroupCount", "export");

                entity.Property(e => e.GroupCount1).HasColumnName("GroupCount");
            });
          ...
          // .HasForeignKey<Jobcode>(p => p.JobcodeId)
            ...
            modelBuilder.Entity<MostRecentDatum>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("MostRecentData", "contractor");

                entity.Property(e => e.BestMatchContractorJobId).HasColumnName("BestMatch_ContractorJobId");
            ...
            modelBuilder.Entity<Office365Employee>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Office365_Employees", "hr");
            ...
            modelBuilder.Entity<OrganizationalUnit>(entity =>
            {
                ...
                entity.HasOne(d => d.ManagedByGu)
                    .WithMany(p => p.OrganizationalUnits)
                    .HasForeignKey(d => d.ManagedByGuid)
            ...
            modelBuilder.Entity<StaffTermination>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("StaffTermination", "export");
            ...
            modelBuilder.Entity<User>(entity =>
            {
               ...
               entity.HasOne(d => d.ManagerGu)
                ...
                entity.HasOne(d => d.OrganizationalUnitGu)
                   .WithMany(p => p.Users)
                    .HasForeignKey(d => d.OrganizationalUnitGuid)
            ...
            modelBuilder.Entity<UserGroupMembership>(entity =>
            {
                ...
                entity.ToView("UserGroupMemberships", "export");
                ...
                entity.Property(e => e.NameAndPath).HasMaxLength(256);
            });
            ...
            modelBuilder.Entity<Select_StaffManagementView_Employees>(entity =>
                {
                    entity.HasNoKey();
                });
            ...
            modelBuilder.Entity<Select_Available_JobTitles>(entity =>
            {
                entity.HasNoKey();
            });
            ...
            modelBuilder.Entity<EmployeeJobTitleAssignmentInfo>(entity =>
            {
                entity.HasNoKey();
                entity.ToTable( "JobTitleAssignment",  "dbo");
            });
